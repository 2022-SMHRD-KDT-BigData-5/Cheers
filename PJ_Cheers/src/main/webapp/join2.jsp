                    ...
                    <div class="join">
                        <form action="JoinCon" method="post">
                            <table class="join_table" align="center">
                                ...
                                <tr>
                                    <td><input type="button" value="중복체크" onclick="idCheck()" style="border: none;"></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td class="table_name" colspan="3" rowspan="2"><input type="submit" value="회원가입" class="button fit" style="border:none;"></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                    ...
                    <div class="col-sm-12">
                        <div class="copyright_text text-center">
                            <p class=" wow fadeInRight" data-wow-duration="1s">Made with <i class="fa fa-heart"></i> by
                                <a target="_blank" href="http://bootstrapthemes.co">Bootstrap
                                    Themes</a>2016. All Rights
                                Reserved
                            </p>
                        </div>
                    </div>
