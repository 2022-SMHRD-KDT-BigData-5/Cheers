                        ...
                        <div class="single_service_area">
                            <div class="base_btn">
                                ...
                                <div class="base_controls">
                                    <button type="button" class="base_soju"><a href="https://www.teleparty.com">넷플릭스</a></button>
                                    <button type="button" class="base_macju"><a href="#">왓챠</a></button>
                                    <div class="insert_btn" align=right><button type="button" style="border: none;"><a href=soto2.jsp>작성</a></button></div>
                                </div>
                                <hr color='#c06c84'>
                  <div class="main_service_area">
                        ...
                        <c:forEach var="s" items="${sotoList}">
                           <table width="100%">
                              <tr>
                                 ...
                                 <td align="right"><button style="border:none; background-color: #fff;"><a href="soto3.jsp">수정</a></button><span> | </span><button style="border:none; background-color: #fff;"><a href="soto1.jsp">삭제</a></button></td>
                              </tr>
                              <tr>
                                 <td colspan="2" align="right"><b><c:out value="${s.member_id}" /></b><span> | <c:out value="${s.soto_date}" /></span></td>
                              </tr>
                           </table>
                           
                           <!-- 댓글 작성 및 조회 -->
                           <p></p>
                           <form class="soto_com_insert" method="post" action="AddSotoCommentCon" align="right">
                                    ...
                                    <c:when test="${s.soto_no eq d.soto_no}">
                                       ...
                                       <table width="100%">
                                          <tr>
                                             ...
                                             <td width="20%"><c:out value="${d.sc_date}" /><br><b><c:out value="${d.member_id}" /></b></td>
