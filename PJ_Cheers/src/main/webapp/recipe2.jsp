                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-sm-push-1">
                                        <div class="single_service">
                                            <br><br><br>
                                            <h3><span class="recipe_name">술이름DB</span></h3>
                                            <h5>base : <span class="recipe_base">베이스DB</span></h5>
                                            <div class="separator2"></div>
                                            <span>♡ 준비물 ♡</span><br>
                                                <span class="recipe_ing">준비물내용DB</span><br><br>
                                                <span>♥ 제조방법 ♥</span><br>
                                                <p class="recipe_how"> 제조방법내용DB</p>
                                        </div>
                                    </div>
                                </div>
