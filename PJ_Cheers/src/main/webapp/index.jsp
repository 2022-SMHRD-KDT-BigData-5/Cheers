                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true">같이마실래?</a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="toast.html">work page</a></li>
                                                    <li><a href="work1.html">work page Two</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true">같이볼래?</a>
                                                <ul class="dropdown-menu">
                        ...
                        <div class="main_home_slider text-center">
                            <div class="single_home_slider">
                                ...
                                <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                    ...
                                    <p class="subtitle">♡ 홈레시피 ♡ <br />
                                        맛있는 술을 쉽게 만들어 먹을 수 있게 레시피를 제공해주는 공간 </p>
                                    <div class="home_btn">
                            ...
                            <div class="single_home_slider">
                                ...
                                <div class="main_home wow fadeInUp" data-wow-duration="700ms"> 
                                    <h2>같이마실래?</h2>
                                    <div class="separator"></div>
                                    <p class="subtitle">♡ 랜선짠 ♡<br />
                                        따로 또 같이 즐기는 술 마시는 공간</p>
                                    <div class="home_btn">
                            ...
                            <div class="single_home_slider">
                                ...
                                <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                    <h2>같이볼래?</h2>
                                    <div class="separator"></div>
                                    <p class="subtitle">♡ OTT매칭 ♡ <br />
                                        따로 또 같이 보면서 술을 즐기는 공간</p>
                                    <div class="home_btn">
                                        <a href="" class="btn">Learn More</a>
                                    </div>
                                </div>
